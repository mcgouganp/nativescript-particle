...
declare class ParticleGetLocationPermissionViewController extends ParticleSetupUIViewController implements CLLocationManagerDelegate {

	static alloc(): ParticleGetLocationPermissionViewController; // inherited from NSObject

	static new(): ParticleGetLocationPermissionViewController; // inherited from NSObject
...
declare class ParticleSetupCustomization extends NSObject {
	...
	appResourcesStoryboardName: string;
...
declare class ParticleSetupSpacerView extends UIView {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): ParticleSetupSpacerView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): ParticleSetupSpacerView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): ParticleSetupSpacerView; // inherited from UIAppearance
...
declare class ParticleSetupUIButton extends UIButton {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): ParticleSetupUIButton; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): ParticleSetupUIButton; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): ParticleSetupUIButton; // inherited from UIAppearance
	...
	static systemButtonWithImageTargetAction(image: UIImage, target: any, action: string): ParticleSetupUIButton; // inherited from UIButton
...
declare class ParticleSetupUILabel extends UILabel {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): ParticleSetupUILabel; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): ParticleSetupUILabel; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): ParticleSetupUILabel; // inherited from UIAppearance
...
declare class ParticleSetupUISpinner extends UIImageView {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): ParticleSetupUISpinner; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): ParticleSetupUISpinner; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): ParticleSetupUISpinner; // inherited from UIAppearance
...
declare class ParticleSetupUIViewController extends UIViewController {
	...
	replaceSetupStrings(target: UIView): void;
...
declare class ParticleSetupWifiTableViewCell extends UITableViewCell {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): ParticleSetupWifiTableViewCell; // inherited from UIAppearance
	...
	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): ParticleSetupWifiTableViewCell; // inherited from UIAppearance
