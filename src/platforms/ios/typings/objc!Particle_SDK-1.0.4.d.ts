...
declare class ParticleCloud extends NSObject {
	...
	addCardCompletion(stripeTokenId: string, completion: (p1: NSError) => void): NSURLSessionDataTask;
	...
	getSimCompletion(iccid: string, completion: (p1: ParticleSimInfo, p2: NSError) => void): NSURLSessionDataTask;
...
declare class ParticleDevice extends NSObject {
	...
	readonly systemFirmwareVersion: string;
	...
	ping(completion: (p1: boolean, p2: NSError) => void): NSURLSessionDataTask;
	...
	setNotesCompletion(notes: string, completion: (p1: NSError) => void): NSURLSessionDataTask;
...
declare const enum ParticleSimDetailedStatus {

	Activate = 0,

	InactiveNeverActivated = 1,

	InactivateUserDeactivated = 2,

	InactiveDataLimitReached = 3,

	InactiveInvalidPayment = 4
}

declare class ParticleSimInfo extends NSObject {

	static alloc(): ParticleSimInfo; // inherited from NSObject

	static new(): ParticleSimInfo; // inherited from NSObject

	readonly mbLimit: number;

	readonly status: ParticleSimDetailedStatus;
